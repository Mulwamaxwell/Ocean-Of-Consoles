...
class NintwoActivity : AppCompatActivity() {
    lateinit var ntpay: Button
    lateinit var ntcall: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_nintwo)
        ntpay=findViewById(R.id.npaytwo)
        ntcall=findViewById(R.id.ncalltwo)
        ntpay.setOnClickListener {
            var box = AlertDialog.Builder(this)
            box.setTitle("Nintendo WII @8000/=")
            box.setMessage("You are about to pay for Nintendo WII. Click Ok to Continue")
        ...
        ntcall.setOnClickListener {
            ...
            box2.setTitle("Nintendo WII Rent @5000/=")
            box2.setMessage("You are about to Rent for Nintendo WII. Click Ok to Continue")
