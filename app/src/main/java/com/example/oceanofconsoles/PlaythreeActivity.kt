...
class PlaythreeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_playthree)

        plpay=findViewById(R.id.ppaythree)
        plcall=findViewById(R.id.playcallthree)
        plpay.setOnClickListener {
            var box = AlertDialog.Builder(this)
            box.setTitle("Playstation Two(2000) @16000/=")
            box.setMessage("You are about to pay for Playstation Two(2000) . Click Ok to Continue")
        ...
        plcall.setOnClickListener {
            ...
            box2.setTitle("Playstation Two(2000) Rent @7000/=")
            box2.setMessage("You are about to Rent for Playstation Two(2000). Click Ok to Continue")
