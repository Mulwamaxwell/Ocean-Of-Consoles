...
class NinfiveActivity : AppCompatActivity() {
    lateinit var ntpay: Button
    lateinit var ntcall: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ninfive)
        ntpay=findViewById(R.id.npayfive)
        ntcall=findViewById(R.id.ncallfive)
        ntpay.setOnClickListener {
            var box = AlertDialog.Builder(this)
            box.setTitle("Nintendo Game Cube @16000/=")
            box.setMessage("You are about to pay for Nintendo Game Cube. Click Ok to Continue")
        ...
        ntcall.setOnClickListener {
            ...
            box2.setTitle("Nintendo Game Cube Rent @7000/=")
            box2.setMessage("You are about to Rent for Nintendo Game Cube. Click Ok to Continue")
