...
class NinsixteenActivity : AppCompatActivity() {
    lateinit var ntpay: Button
    lateinit var ntcall: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ninsixteen)
        ntpay=findViewById(R.id.npaysixteen)
        ntcall=findViewById(R.id.ncallsixteen)
        ntpay.setOnClickListener {
            var box = AlertDialog.Builder(this)
            box.setTitle("Nintendo 3DS XL @16000/=")
            box.setMessage("You are about to pay for Nintendo 3DS XL. Click Ok to Continue")
        ...
        ntcall.setOnClickListener {
            ...
            box2.setTitle("Nintendo Nintendo 3DS XL @3000/=")
            box2.setMessage("You are about to Rent for Nintendo 3DS XL. Click Ok to Continue")
