...
class PlaynineActivity : AppCompatActivity() {
    lateinit var plpay: Button
    lateinit var plcall: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_playnine)
        plpay=findViewById(R.id.ppaynine)
        plcall=findViewById(R.id.playcallnine)
        plpay.setOnClickListener {
            var box = AlertDialog.Builder(this)
            box.setTitle("Playstation Four Slim @38000/=")
            box.setMessage("You are about to pay for Playstation Four Slim. Click Ok to Continue")
        ...
        plcall.setOnClickListener {
            ...
            box2.setTitle("Playstation Four Slim Rent @19000/=")
            box2.setMessage("You are about to Rent for Playstation Four Slim. Click Ok to Continue")
