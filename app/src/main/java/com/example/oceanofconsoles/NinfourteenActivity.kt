...
class NinfourteenActivity : AppCompatActivity() {
    lateinit var ntpay: Button
    lateinit var ntcall: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ninfourteen)
        ntpay=findViewById(R.id.npayfourteen)
        ntcall=findViewById(R.id.ncallfourteen)
        ntpay.setOnClickListener {
            var box = AlertDialog.Builder(this)
            box.setTitle("Nintendo Game Watch @29000/=")
            box.setMessage("You are about to pay for Nintendo Gamewatch. Click Ok to Continue")
        ...
        ntcall.setOnClickListener {
            ...
            box2.setTitle("Nintendo Game Watch Rent @9000/=")
            box2.setMessage("You are about to Rent for Nintendo Gamewatch. Click Ok to Continue")
