...
class NinnineActivity : AppCompatActivity() {
    lateinit var ntpay: Button
    lateinit var ntcall: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ninnine)
        ntpay=findViewById(R.id.npaynine)
        ntcall=findViewById(R.id.ncallnine)
        ntpay.setOnClickListener {
            var box = AlertDialog.Builder(this)
            box.setTitle("Nintendo Game Boy Advanced @15000/=")
            box.setMessage("You are about to pay for Nintendo Game Boy Advanced. Click Ok to Continue")
        ...
        ntcall.setOnClickListener {
            ...
            box2.setMessage("You are about to Rent for Nintendo Game Boy Advanced. Click Ok to Continue")
