...
class NinoneActivity : AppCompatActivity() {
    lateinit var ntpay: Button
    lateinit var ntcall: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ninone)

        ntpay=findViewById(R.id.npayone)
        ntcall=findViewById(R.id.ncallone)
        ntpay.setOnClickListener {
            var box = AlertDialog.Builder(this)
            box.setTitle("Nintendo Entertainment @5000/=")
            box.setMessage("You are about to pay for Nintendo Entertainment. Click Ok to Continue")
        ...
        ntcall.setOnClickListener {
            ...
            box2.setTitle("Nintendo Entertainment Rent @2000/=")
            box2.setMessage("You are about to Rent for Nintendo Entertainment. Click Ok to Continue")
