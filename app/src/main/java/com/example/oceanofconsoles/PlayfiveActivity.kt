...
class PlayfiveActivity : AppCompatActivity() {
    lateinit var plpay: Button
    lateinit var plcall: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_playfive)
        plpay=findViewById(R.id.ppayfive)
        plcall=findViewById(R.id.playcallfive)
        plpay.setOnClickListener {
            var box = AlertDialog.Builder(this)
            box.setTitle("Playstation Three @20000/=")
            box.setMessage("You are about to pay for Playstation Three. Click Ok to Continue")
        ...
        plcall.setOnClickListener {
            ...
            box2.setTitle("Playstation Three Rent @9000/=")
            box2.setMessage("You are about to Rent for Playstation Three. Click Ok to Continue")
