...
class NintwelveActivity : AppCompatActivity() {
    lateinit var ntpay: Button
    lateinit var ntcall: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_nintwelve)
        ntpay=findViewById(R.id.npaytwelve)
        ntcall=findViewById(R.id.ncalltwelve)
        ntpay.setOnClickListener {
            var box = AlertDialog.Builder(this)
            box.setTitle("Nintendo WII U Advanced @28000/=")
            box.setMessage("You are about to pay for Nintendo WII U. Click Ok to Continue")
        ...
        ntcall.setOnClickListener {
            ...
            box2.setTitle("Nintendo WII U Advanced Rent @10000/=")
            box2.setMessage("You are about to Rent for Nintendo WII U. Click Ok to Continue")
