...
class PcsevenActivity : AppCompatActivity() {
    lateinit var pcpay: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pcseven)
        pcpay=findViewById(R.id.pcpay7)
        pcpay.setOnClickListener {
            var box = AlertDialog.Builder(this)
            box.setTitle("IHWIO Box Advanced Gaming PC @300000/=")
            box.setMessage("You are about to pay for IHWIO Box Advanced Gaming PC. Click Ok to Continue")
