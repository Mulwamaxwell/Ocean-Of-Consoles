...
class NinseventeenActivity : AppCompatActivity() {
    lateinit var ntpay: Button
    lateinit var ntcall: Button
        override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ninseventeen)
            ntpay=findViewById(R.id.npayseventeen)
            ntcall=findViewById(R.id.ncallseventeen)
            ntpay.setOnClickListener {
                var box = AlertDialog.Builder(this)
                box.setTitle("Nintendo Switch @36000/=")
                box.setMessage("You are about to pay for Nintendo Switch. Click Ok to Continue")
            ...
            ntcall.setOnClickListener {
                ...
                box2.setTitle("Nintendo Nintendo Switch @6000/=")
                box2.setMessage("You are about to Rent for Nintendo Switch. Click Ok to Continue")
