...
class PlaytenActivity : AppCompatActivity() {
    lateinit var plpay: Button
    lateinit var plcall: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_playten)
        plpay=findViewById(R.id.ppayten)
        plcall=findViewById(R.id.playcallten)
        plpay.setOnClickListener {
            var box = AlertDialog.Builder(this)
            box.setTitle("Playstation Four PRO @43000/=")
            box.setMessage("You are about to pay for Playstation Four PRO. Click Ok to Continue")
        ...
        plcall.setOnClickListener {
            ...
            box2.setTitle("Playstation Four PRO Rent @22000/=")
            box2.setMessage("You are about to Rent for Playstation Four PRO. Click Ok to Continue")
