...
class NinthreeActivity : AppCompatActivity() {
    lateinit var ntpay: Button
    lateinit var ntcall: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ninthree)
        ntpay=findViewById(R.id.npaythree)
        ntcall=findViewById(R.id.ncallthree)
        ntpay.setOnClickListener {
            var box = AlertDialog.Builder(this)
            box.setTitle("Nintendo WII U @28000/=")
        ...
        ntcall.setOnClickListener {
            ...
            box2.setTitle("Nintendo WII U Rent @15000/=")
