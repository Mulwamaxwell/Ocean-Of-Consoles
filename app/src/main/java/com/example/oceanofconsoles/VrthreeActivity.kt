...
class VrthreeActivity : AppCompatActivity() {
    lateinit var vpay: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_vrthree)
        vpay=findViewById(R.id.vr003)
        vpay.setOnClickListener {
            var box = AlertDialog.Builder(this)
            box.setTitle("MetaQuest Virtual Reality @100000/=")
            box.setMessage("You are about to pay for Meta Quest Virtual Reality. Click Ok to Continue")
