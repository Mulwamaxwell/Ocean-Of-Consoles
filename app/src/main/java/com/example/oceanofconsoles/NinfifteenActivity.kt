...
class NinfifteenActivity : AppCompatActivity() {
    lateinit var ntpay: Button
    lateinit var ntcall: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ninfifteen)
        ntpay=findViewById(R.id.npayfifteen)
        ntcall=findViewById(R.id.ncallfifteen)
        ntpay.setOnClickListener {
            var box = AlertDialog.Builder(this)
            box.setTitle("Nintendo Game Watch @36000/=")
            box.setMessage("You are about to pay for Nintendo Game Watch. Click Ok to Continue")
        ...
        ntcall.setOnClickListener {
            ...
            box2.setTitle("Nintendo Game Watch Rent @6000/=")
            box2.setMessage("You are about to Rent for Nintendo Game Watch. Click Ok to Continue")
