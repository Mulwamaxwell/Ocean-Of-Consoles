...
class PctwoActivity : AppCompatActivity() {
    lateinit var pcpay: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pctwo)
        pcpay=findViewById(R.id.pcpay2)
        pcpay.setOnClickListener {
            var box = AlertDialog.Builder(this)
            box.setTitle("Zoostom HD Advanced Gaming PC @200000/=")
            box.setMessage("You are about to pay for Zoostom HD Advanced Gaming PC. Click Ok to Continue")
