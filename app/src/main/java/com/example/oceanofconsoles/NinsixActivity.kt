...
class NinsixActivity : AppCompatActivity() {
    lateinit var ntpay: Button
    lateinit var ntcall: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ninsix)
        ntpay=findViewById(R.id.npaysix)
        ntcall=findViewById(R.id.ncallsix)
        ntpay.setOnClickListener {
            var box = AlertDialog.Builder(this)
            box.setTitle("Nintendo Virtual Boy @26000/=")
            box.setMessage("You are about to pay for Nintendo Virtual Boy. Click Ok to Continue")
        ...
        ntcall.setOnClickListener {
            ...
            box2.setTitle("Nintendo Virtual Boy @7000/=")
            box2.setMessage("You are about to Rent for Nintendo Virtual Boy. Click Ok to Continue")
