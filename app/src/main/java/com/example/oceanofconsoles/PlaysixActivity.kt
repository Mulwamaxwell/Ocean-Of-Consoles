...
class PlaysixActivity : AppCompatActivity() {
    lateinit var plpay: Button
    lateinit var plcall: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_playsix)
        plpay=findViewById(R.id.ppaysix)
        plcall=findViewById(R.id.playcallsix)
        plpay.setOnClickListener {
            var box = AlertDialog.Builder(this)
            box.setTitle("Playstation Three Slim @22000/=")
            box.setMessage("You are about to pay for Playstation Three Slim. Click Ok to Continue")
        ...
        plcall.setOnClickListener {
            ...
            box2.setTitle("Playstation Three Slim Rent @10000/=")
            box2.setMessage("You are about to Rent for Playstation Three Slim. Click Ok to Continue")
