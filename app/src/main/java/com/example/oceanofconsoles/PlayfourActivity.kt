...
class PlayfourActivity : AppCompatActivity() {
    lateinit var plpay: Button
    lateinit var plcall: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_playfour)

        plpay=findViewById(R.id.ppayfour)
        plcall=findViewById(R.id.playcallfour)
        plpay.setOnClickListener {
            var box = AlertDialog.Builder(this)
            box.setTitle("Playstation Two Slim @18000/=")
            box.setMessage("You are about to pay for Playstation Two Slim. Click Ok to Continue")
        ...
        plcall.setOnClickListener {
            ...
            box2.setTitle("Playstation Two Slim Rent @7000/=")
            box2.setMessage("You are about to Rent for Playstation Two Slim. Click Ok to Continue")
